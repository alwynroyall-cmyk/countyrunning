"""Run WRRL League AI autopilot workflow for one season.
...
from league_scorer.input_layout import build_input_paths, ensure_input_subdirs, sort_existing_input_files
...
def _to_markdown(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# WRRL League AI Autopilot Report",
        "",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run WRRL League AI autopilot for one season."
    )
